...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'picwall.askforfriendmessage': {
            'Meta': {'object_name': 'AskForFriendMessage'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'picwall.photowall': {
            ...
            'create_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 19, 0, 0)'}),
            ...
            'modify_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 19, 0, 0)'}),
