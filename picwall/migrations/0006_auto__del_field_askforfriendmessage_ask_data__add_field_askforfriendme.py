...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AskForFriendMessage.ask_date'
        db.add_column(u'picwall_askforfriendmessage', 'ask_date',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AskForFriendMessage.ask_date'
        db.delete_column(u'picwall_askforfriendmessage', 'ask_date')
    ...
    models = {
        ...
        u'picwall.askforfriendmessage': {
            ...
            'ask_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
