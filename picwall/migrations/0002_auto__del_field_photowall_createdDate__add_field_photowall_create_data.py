...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PhotoWall.createdDate'
        db.delete_column(u'picwall_photowall', 'createdDate')

        # Adding field 'PhotoWall.create_data'
        db.add_column(u'picwall_photowall', 'create_data',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 6, 5, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PhotoWall.createdDate'
        raise RuntimeError("Cannot reverse this migration. 'PhotoWall.createdDate' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PhotoWall.createdDate'
        db.add_column(u'picwall_photowall', 'createdDate',
