...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoWall.access_times'
        db.add_column(u'picwall_photowall', 'access_times',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhotoWall.access_times'
        db.delete_column(u'picwall_photowall', 'access_times')
