...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Picture.url'
        db.delete_column(u'picwall_picture', 'url')

        # Deleting field 'Picture.desc'
        db.delete_column(u'picwall_picture', 'desc')

        # Adding field 'Picture.description'
        db.add_column(u'picwall_picture', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'PhotoWall.create_data'
        db.delete_column(u'picwall_photowall', 'create_data')

        # Deleting field 'PhotoWall.modify_data'
        db.delete_column(u'picwall_photowall', 'modify_data')

        # Adding field 'PhotoWall.create_date'
        db.add_column(u'picwall_photowall', 'create_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 10, 0, 0)),
                      keep_default=False)

        # Adding field 'PhotoWall.modify_date'
        db.add_column(u'picwall_photowall', 'modify_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 10, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Picture.url'
        raise RuntimeError("Cannot reverse this migration. 'Picture.url' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Picture.url'
        db.add_column(u'picwall_picture', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=200),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Picture.desc'
        raise RuntimeError("Cannot reverse this migration. 'Picture.desc' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Picture.desc'
        db.add_column(u'picwall_picture', 'desc',
                      self.gf('django.db.models.fields.CharField')(max_length=100),
                      keep_default=False)

        # Deleting field 'Picture.description'
        db.delete_column(u'picwall_picture', 'description')

        # Adding field 'PhotoWall.create_data'
        db.add_column(u'picwall_photowall', 'create_data',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 10, 0, 0)),
                      keep_default=False)

        # Adding field 'PhotoWall.modify_data'
        db.add_column(u'picwall_photowall', 'modify_data',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 10, 0, 0)),
                      keep_default=False)

        # Deleting field 'PhotoWall.create_date'
        db.delete_column(u'picwall_photowall', 'create_date')

        # Deleting field 'PhotoWall.modify_date'
        db.delete_column(u'picwall_photowall', 'modify_date')
    ...
    models = {
        ...
        u'picwall.photowall': {
            ...
            'create_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 10, 0, 0)'}),
            ...
            'modify_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 10, 0, 0)'}),
        ...
        u'picwall.picture': {
            ...
            'pid': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
