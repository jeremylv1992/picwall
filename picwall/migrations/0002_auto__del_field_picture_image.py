...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'picwall_picture', 'image')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Picture.image'
        raise RuntimeError("Cannot reverse this migration. 'Picture.image' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Picture.image'
        db.add_column(u'picwall_picture', 'image',
    ...
    models = {
        ...
        u'picwall.photowall': {
            ...
            'create_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
            ...
            'modify_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
