...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PhotoInformation.top'
        db.alter_column(u'picwall_photoinformation', 'top', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'PhotoInformation.left'
        db.alter_column(u'picwall_photoinformation', 'left', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):

        # Changing field 'PhotoInformation.top'
        db.alter_column(u'picwall_photoinformation', 'top', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'PhotoInformation.left'
        db.alter_column(u'picwall_photoinformation', 'left', self.gf('django.db.models.fields.FloatField')())
