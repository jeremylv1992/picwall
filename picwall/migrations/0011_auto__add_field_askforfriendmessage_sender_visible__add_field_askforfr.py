...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AskForFriendMessage.sender_visible'
        db.add_column(u'picwall_askforfriendmessage', 'sender_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'AskForFriendMessage.receiver_visible'
        db.add_column(u'picwall_askforfriendmessage', 'receiver_visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AskForFriendMessage.sender_visible'
        db.delete_column(u'picwall_askforfriendmessage', 'sender_visible')

        # Deleting field 'AskForFriendMessage.receiver_visible'
        db.delete_column(u'picwall_askforfriendmessage', 'receiver_visible')
    ...
    models = {
        ...
        u'picwall.photowall': {
            ...
            'create_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 27, 0, 0)'}),
            ...
            'modify_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 27, 0, 0)'}),
        ...
        u'picwall.photowallcomment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'published_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 27, 0, 0)'}),
