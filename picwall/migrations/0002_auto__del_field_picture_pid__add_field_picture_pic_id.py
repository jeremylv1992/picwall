...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Picture.pic_id'
        db.add_column(u'picwall_picture', 'pic_id',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 6, 6, 0, 0), max_length=100),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Picture.pid'
        raise RuntimeError("Cannot reverse this migration. 'Picture.pid' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Picture.pid'
        db.add_column(u'picwall_picture', 'pid',
                      self.gf('django.db.models.fields.CharField')(max_length=100),
                      keep_default=False)

        # Deleting field 'Picture.pic_id'
        db.delete_column(u'picwall_picture', 'pic_id')
