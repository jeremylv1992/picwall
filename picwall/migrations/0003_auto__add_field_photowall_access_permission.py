...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoWall.access_permission'
        db.add_column(u'picwall_photowall', 'access_permission',
                      self.gf('django.db.models.fields.CharField')(default='private', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhotoWall.access_permission'
        db.delete_column(u'picwall_photowall', 'access_permission')
    ...
    models = {
        ...
        u'picwall.photowall': {
            ...
            'create_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 18, 0, 0)'}),
            ...
            'modify_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 18, 0, 0)'}),
