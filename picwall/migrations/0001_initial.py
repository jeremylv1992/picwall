...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'picwall_picturelabel', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['picwall.WebSiteUser'])),
        ))
        ...
        db.create_table(u'picwall_picture', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pid', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(default='name', max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(default='description', max_length=100)),
            ...
            ('label', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['picwall.PictureLabel'])),
        ))
        ...
        db.create_table(u'picwall_photowall', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photowall_creator', to=orm['picwall.WebSiteUser'])),
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=256)),
            ('create_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 14, 0, 0))),
            ('modify_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 14, 0, 0))),
    ...
    models = {
        ...
        u'picwall.photowall': {
            ...
            'create_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 14, 0, 0)'}),
            ...
            'modify_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 14, 0, 0)'}),
        ...
        u'picwall.picture': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['picwall.PictureLabel']"}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'name'", 'max_length': '50'}),
        ...
        u'picwall.picturelabel': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['picwall.WebSiteUser']"})
        },
