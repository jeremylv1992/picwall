...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AskForFriendMessage.ask_data'
        db.add_column(u'picwall_askforfriendmessage', 'ask_data',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 20, 0, 0)),
                      keep_default=False)

        # Adding field 'AskForFriendMessage.state'
        db.add_column(u'picwall_askforfriendmessage', 'state',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AskForFriendMessage.ask_data'
        db.delete_column(u'picwall_askforfriendmessage', 'ask_data')

        # Deleting field 'AskForFriendMessage.state'
        db.delete_column(u'picwall_askforfriendmessage', 'state')
    ...
    models = {
        ...
        u'picwall.askforfriendmessage': {
            'Meta': {'ordering': "('ask_data',)", 'object_name': 'AskForFriendMessage'},
            'ask_data': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 20, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'picwall.photowall': {
            ...
            'create_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 20, 0, 0)'}),
            ...
            'modify_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 20, 0, 0)'}),
        ...
        u'picwall.picturecomment': {
            ...
            'published_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 20, 0, 0)'})
        },
