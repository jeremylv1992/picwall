...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'picwall_photoinformation', (
            ...
            ('wall', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['picwall.PhotoWall'])),
        ))
    ...
    models = {
        ...
        u'picwall.photoinformation': {
            ...
            'wall': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['picwall.PhotoWall']"})
        },
        u'picwall.photowall': {
